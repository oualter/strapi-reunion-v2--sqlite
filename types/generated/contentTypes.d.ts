...
export interface ApiPlaceDeLaReunionPlaceDeLaReunion
  extends Schema.CollectionType {
  collectionName: 'place_de_la_reunions';
  info: {
    singularName: 'place-de-la-reunion';
    pluralName: 'place-de-la-reunions';
    displayName: 'Microfiction Place de la r\u00E9union';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::place-de-la-reunion.place-de-la-reunion',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
